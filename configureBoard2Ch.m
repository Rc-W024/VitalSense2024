function [result] = configureBoard2Ch(boardHandle,decimation,wfrm)
...
retCode = ...
    AlazarSetCaptureClock(  ...
        ...
        decimation-1                   ... % U32 -- clock decimation
        );
...
retCode = ...
    AlazarInputControlEx(             ...
        ...
        IMPEDANCE_1M_OHM    ... % U32 -- input impedance id
        );
if retCode ~= ApiSuccess
...
retCode = ...
    AlazarInputControlEx(             ...
        ...
        INPUT_RANGE_PM_5_V, ... % U32 -- input range id
        IMPEDANCE_1M_OHM     ... % U32 -- input impedance id
        );
if retCode ~= ApiSuccess
    fprintf('Error: AlazarInputControlEx failed -- %s\n', errorToText(retCode));
...
retCode = ...
    AlazarSetTriggerOperation( ...
        ...
        100,                ... % U32 -- trigger level from 0 (-range) to 255 (+range) 0%=128;25%=160
