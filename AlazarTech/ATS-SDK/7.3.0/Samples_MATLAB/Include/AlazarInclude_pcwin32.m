...
%This function was generated by loadlibrary.m parser version  on Wed Jun  5 10:11:42 2019
...
% unsigned int AlazarExtractNPTFootersEx ( void * buffer , U32 options , U32 recordSize_bytes , U32 bufferSize_bytes , NPTFooter * footersArray , U32 numFootersToExtract ); 
fcns.thunkname{fcnNum}='uint32voidPtrulongulongulongvoidPtrulongThunk';fcns.name{fcnNum}='AlazarExtractNPTFootersEx'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'ulong', 'ulong', 's_NPTFooterPtr', 'ulong'};fcnNum=fcnNum+1;
...
% unsigned int AlazarConfigureFastBufferLock ( HANDLE handle , int bufferCount ); 
fcns.thunkname{fcnNum}='uint32voidPtrint32Thunk';fcns.name{fcnNum}='AlazarConfigureFastBufferLock'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32'};fcnNum=fcnNum+1;
...
% unsigned int AlazarDSPGetInfo ( dsp_module_handle dspHandle , U32 * dspModuleId , U16 * versionMajor , U16 * versionMinor , U32 * maxLength , U32 * supportedChannels , U32 * reserved1 ); 
...
enuminfo.ALAZAR_DATA_LAYOUT=struct('ALAZAR_DATA_LAYOUT_BUFFER_INTERLEAVED',1048576,'ALAZAR_DATA_LAYOUT_RECORD_INTERLEAVED',2097152,'ALAZAR_DATA_LAYOUT_SAMPLE_INTERLEAVED',3145728);
enuminfo.ALAZAR_DATA_DOMAIN=struct('ALAZAR_DATA_DOMAIN_TIME',4096,'ALAZAR_DATA_DOMAIN_FREQUENCY',8192);
...
enuminfo.ALAZAR_ACTIVE_CHANNEL_COUNT=struct('ALAZAR_ACTIVE_CHANNEL_COUNT_1',65536,'ALAZAR_ACTIVE_CHANNEL_COUNT_2',131072,'ALAZAR_ACTIVE_CHANNEL_COUNT_4',196608,'ALAZAR_ACTIVE_CHANNEL_COUNT_8',262144,'ALAZAR_ACTIVE_CHANNEL_COUNT_16',327680);
