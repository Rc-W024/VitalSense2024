...
% final vaule of T
if length(T2_save)==10
    % autocorrelation for period determination
    [c,lags]=xcorr(sig);
...
if amp_std>0.5
    ...
    amp_hsig=amp_hsig_test;
    locs_hsig=locs_hsig_test;
end
...
% find the locs...
[amph,locsh]=findpeaks(hsig(1:len_sig),1:len_sig,'MinPeakDistance',minpeakdist_d,'MinPeakProminence',minprom_d);
